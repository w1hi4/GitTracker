                ...
                <div className="space-y-4 relative z-10">
                  <div>
                    ...
                    <p className="text-xs text-gray-400 mt-2 leading-relaxed">
                      GitHub limits unauthenticated requests to 60 per hour. Add a token to increase this limit to 5,000 per hour. Your token is stored locally in your browser.
                    </p>
                  </div>
